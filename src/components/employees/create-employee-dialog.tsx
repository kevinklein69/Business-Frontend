...
const emptyForm = {
  ...
  initialBalanceHours: '0', initialVacationDaysTaken: '0',
}
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <div className="flex flex-col gap-4 py-1 max-h-[70vh] overflow-y-auto pr-1">
          ...
          <div className="flex flex-col gap-3 border-t pt-3">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="e-initialVacationDaysTaken">Bereits genommene Urlaubstage (dieses Jahr)</Label>
              <Input
                id="e-initialVacationDaysTaken"
                type="number"
                min={0}
                step="0.5"
          ...
          <div className="flex flex-col gap-3 border-t pt-3">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="e-initialBalanceHours">Anfangssaldo (Stunden)</Label>
              <Input
                id="e-initialBalanceHours"
                type="number"
                step="0.5"
